...
#   
#   hdv_data$govde_tipi=="otobus"&between(hdv_data$agirlik,0,1500)&between(hdv_data$oturma_yeri,0,Inf) ~ 10,
#   hdv_data$govde_tipi=="otobus"&between(hdv_data$agirlik,1501,3500)&between(hdv_data$oturma_yeri,0,Inf) ~ 11,
#   hdv_data$govde_tipi=="otobus"&between(hdv_data$agirlik,3501,5000)&between(hdv_data$oturma_yeri,0,Inf) ~ 12,
#   hdv_data$govde_tipi=="otobus"&between(hdv_data$agirlik,5001,10000)&between(hdv_data$oturma_yeri,0,Inf) ~ 13,
#   hdv_data$govde_tipi=="otobus"&between(hdv_data$agirlik,10001,20000)&between(hdv_data$oturma_yeri,0,Inf) ~ 14,
#   hdv_data$govde_tipi=="otobus"&between(hdv_data$agirlik,20001,Inf)&between(hdv_data$oturma_yeri,0,Inf) ~ 15,
#   
#   TRUE ~  0
# )
...
# 
# 
# hdv_data$lifetime_mtv <- lcv_mtv_oranlari$lifetime_mtv[match(hdv_data$mtv_grubu,lcv_mtv_oranlari$mtv_grubu)]
# 
# 
# 
...
# 
# 
# hdv_data$yeni_mtv_co2_araliklari <- lcv_mtv_grubu_co2_araliklari$yeni_mtv_co2_araliklari[match
